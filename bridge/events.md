...
[Events](#/api_events?id=events)
================================

[Server level events](#/api_events?id=server-level-events)
----------------------------------------------------------

### [`shutdown`](#/api_events?id=shutdown)
...
[Driver level events](#/api_events?id=driver-level-events)
----------------------------------------------------------

### [`verify code`](#/api_events?id=verify-code)
...
### [`captcha request`](#/api_events?id=captcha-request)
...
### [`connected`](#/api_events?id=connected)
...
### [`disconnected`](#/api_events?id=disconnected)
...
### [`push connected`](#/api_events?id=push-connected)
...
### [`push disconnected`](#/api_events?id=push-disconnected)
...
### [`mqtt connected`](#/api_events?id=mqtt-connected)
...
### [`mqtt disconnected`](#/api_events?id=mqtt-disconnected)
...
### [`log level changed`](#/api_events?id=log-level-changed)
...
### [`connection error`](#/api_events?id=connection-error)
...
[Station level events](#/api_events?id=station-level-events)
------------------------------------------------------------

### [`station added`](#/api_events?id=station-added)
...
### [`station removed`](#/api_events?id=station-removed)
...
### [`guard mode changed`](#/api_events?id=guard-mode-changed)
...
### [`current mode changed`](#/api_events?id=current-mode-changed)
...
### [`command result`](#/api_events?id=command-result)
...
### [`connected`](#/api_events?id=connected-1)
...
### [`disconnected`](#/api_events?id=disconnected-1)
...
### [`property changed`](#/api_events?id=property-changed)
...
### [`alarm event`](#/api_events?id=alarm-event)
...
### [`alarm delay event`](#/api_events?id=alarm-delay-event)
...
### [`alarm armed event`](#/api_events?id=alarm-armed-event)
...
### [`alarm arm delay event`](#/api_events?id=alarm-arm-delay-event)
...
### [`image downloaded`](#/api_events?id=image-downloaded)
...
### [`database query latest`](#/api_events?id=database-query-latest)
...
### [`database query local`](#/api_events?id=database-query-local)
...
### [`database count by date`](#/api_events?id=database-count-by-date)
...
### [`database delete`](#/api_events?id=database-delete)
...
[Device level events](#/api_events?id=device-level-events)
----------------------------------------------------------

### [`device added`](#/api_events?id=device-added)
...
### [`device removed`](#/api_events?id=device-removed)
...
### [`motion detected`](#/api_events?id=motion-detected)
...
### [`person detected`](#/api_events?id=person-detected)
...
### [`stranger person detected`](#/api_events?id=stranger-person-detected)
...
### [`crying detected`](#/api_events?id=crying-detected)
...
### [`sound detected`](#/api_events?id=sound-detected)
...
### [`pet detected`](#/api_events?id=pet-detected)
...
### [`vehicle detected`](#/api_events?id=vehicle-detected)
...
### [`dog detected`](#/api_events?id=dog-detected)
...
### [`dog lick detected`](#/api_events?id=dog-lick-detected)
...
### [`dog poop detected`](#/api_events?id=dog-poop-detected)
...
### [`sensor open`](#/api_events?id=sensor-open)
...
### [`command result`](#/api_events?id=command-result-1)
...
### [`got rtsp url`](#/api_events?id=got-rtsp-url)
...
### [`property changed`](#/api_events?id=property-changed-1)
...
### [`livestream started`](#/api_events?id=livestream-started)
...
### [`livestream stopped`](#/api_events?id=livestream-stopped)
...
### [`livestream video data`](#/api_events?id=livestream-video-data)
...
### [`livestream audio data`](#/api_events?id=livestream-audio-data)
...
### [`download started`](#/api_events?id=download-started)
...
### [`download finished`](#/api_events?id=download-finished)
...
### [`download video data`](#/api_events?id=download-video-data)
...
### [`download audio data`](#/api_events?id=download-audio-data)
...
### [`package delivered`](#/api_events?id=package-delivered)
...
### [`package stranded`](#/api_events?id=package-stranded)
...
### [`package taken`](#/api_events?id=package-taken)
...
### [`someone loitering`](#/api_events?id=someone-loitering)
...
### [`radar motion detected`](#/api_events?id=radar-motion-detected)
...
### [`wrong try-protect alarm`](#/api_events?id=wrong-try-protect-alarm)
...
### [`long time not close`](#/api_events?id=long-time-not-close)
...
### [`low battery`](#/api_events?id=low-battery)
...
### [`alarm 911`](#/api_events?id=alarm-911)
...
### [`shake alarm`](#/api_events?id=shake-alarm)
...
### [`talkback started`](#/api_events?id=talkback-started)
...
### [`talkback stopped`](#/api_events?id=talkback-stopped)
...
### [`user added`](#/api_events?id=user-added)
...
### [`user deleted`](#/api_events?id=user-deleted)
...
### [`user error`](#/api_events?id=user-error)
...
### [`user username updated`](#/api_events?id=user-username-updated)
...
### [`user schedule updated`](#/api_events?id=user-schedule-updated)
...
### [`user passcode updated`](#/api_events?id=user-passcode-updated)
...
### [`pin verified`](#/api_events?id=pin-verified)
...
### [`tampering`](#/api_events?id=tampering)
...
### [`low temperature`](#/api_events?id=low-temperature)
...
### [`high temperature`](#/api_events?id=high-temperature)
...
### [`pin incorrect`](#/api_events?id=pin-incorrect)
...
### [`lid stuck`](#/api_events?id=lid-stuck)
...
### [`battery fully charged`](#/api_events?id=battery-fully-charged)
